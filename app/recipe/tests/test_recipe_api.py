...
RECIPES_ULR = reverse("recipe:recipe_list")
...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        ...
        res = self.clinet.get(RECIPES_ULR)
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipies(self):
        ...
        res = self.client.get(RECIPES_ULR)
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of recipes is limited to authenticated uesr."""
    ...
    def test_create_recipe(self):
        ...
        res = self.client.post(RECIPES_ULR, payload)
